 ...
 */
@WebServlet(name = "ingresogastos", urlPatterns = {"/ingresogastos"})
public class ingresogastos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (gestorBD.registrar(fecha, identi, nombre, obs, valor)) {
